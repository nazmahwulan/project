...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        if (mysqli_affected_rows($conn) > 0) {
            ...
            $_SESSION['error'] = "Update data gagal";
        }
    }
                    ...
                    <div class="card-body">
                        <form action="<?php echo $_SERVER['PHP_SELF'] . "?id=" . $id ?>" method="post">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="Kategori" required value="<?php echo $name ?>">
                            </div>
