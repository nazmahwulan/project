    ...
    <div class="container">
        <div class="row justify-content-center ">
            <main class="col-md-9 ms-sm-auto col-lg-12 px-md-4 py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <a href="create.php" class="btn btn-primary button-blue mb-4" style="color:white;">Tambah Kategori</a>
                                ...
                                <tbody>
                                    ...
                                    foreach ($datas as $key => $data) {
                                        ...
                                        <tr>
                                            ...
                                            <td>' . $data['name'] . '</td>
                                            <td>
                                                <a href="show.php?id=' . $data['id'] . '"class="btn btn-primary button-blue" style=" color:white;">Lihat</a>
                                                <a href="update.php?id=' . $data['id'] . '"class="btn btn-primary button-blue" style=" color:white;">Edit</a>
                                                <a href="delete.php?id=' . $data['id'] . '"class="btn btn-primary button-blue" style=" color:white;">Hapus</a>
                                            </td>
                                        </tr>   
                                         ';
                                    }
