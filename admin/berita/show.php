    ...
    <div class="container">
        <div class="row justify-content-center ">
            <main class="col-md-9 ms-sm-auto col-lg-12 px-md-4 py-4">
                ...
                <h1 class="h2">Melihat Berita</h1>
                <div class="card">
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="category_id" class="form-label">Kategori</label>
                            <input type="text" class="form-control" id="category_id" name="category_id" placeholder="Kategori" required value="<?php echo $category_id ?>" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="title" class="form-label">Judul</label>
                            <input type="text" class="form-control" id="title" name="title" placeholder="Judul" required value="<?php echo $title ?>" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="content" class="form-label">Isi</label>
                            <input type="text" class="form-control" id="content" name="content" placeholder="Isi" required value="<?php echo $content ?>" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="date" class="form-label">Tanggal</label>
                            <input type="text" class="form-control" id="date" name="date" placeholder="Tanggal" required value="<?php echo $date ?>" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="time" class="form-label">Waktu</label>
                            <input type="text" class="form-control" id="time" name="time" placeholder="Waktu" required value="<?php echo $time ?>" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="image" class="form-label" style="float:left;">Gambar</label>
                            <img src="gambar/<?php echo $image ?>" style="width: 120px;margin-right:900px;">
                        </div>
                    </div>
                </div>
            </main>
