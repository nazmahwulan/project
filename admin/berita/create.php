...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO news (category_id, title, content, date, time, image) VALUES ('$category_id', '$title', '$content', '$date', '$time', '$image');";
                    ...
                    <div class="card-body">
                        <form method="POST" action="proses_tambah.php" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="category_id" name="category_id" placeholder="Kategori ID" required>
                                <a href="/project2/admin/kategori">lihat daftar kategori</a>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="content" name="content" placeholder="Isi" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="image" name="image" placeholder="Gambar" required>
                            </div>
                            <p style="color: red; font-size:12px;"><?php if (isset($_SESSION['error'])) {
                                                                        echo ($_SESSION['error']);
                                                                    } ?></p>
                            <button type="submit" name="submit" class="btn btn-primary button-blue my-3" style="color: white;">Save</button>
                        </form>
                    </div>
                </div>
            </main>
