...
<body>
    ...
    <div class="container provide page-detail">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <p class="info1">Hubungi  Kami</p>
                <p class="lead desc">Jika anda mempunyai pertanyaan, hubungi Kami melalui: <br>
                                    Jalan Semangka No.5B, Bandar Lampung, lampung, 3455 <br>
                                    Tel: 62-21 53699200 <br>
                                    Fax: 62-21 53503777</p>
            </div>
        </div>
    </div>
